          ...
          <Container className="mx-auto my-[40px] max-w-[650px] border-[#eaeaea] border-solid p-[20px]">
            ...
            <Section className="mx-0 my-[30px]">
              <Row>
                <Column
                  style={{
                    backgroundImage: `url(https://res.cloudinary.com/dirjvoxdc/image/upload/v1757034184/gemita_welcome_pexoqj.png)`,
                ...
                >
                  <Row style={{ height: "100%" }}>
                    <Column
                      style={{ verticalAlign: "text-top", textAlign: "center", paddingTop: "50px"}}
                      className="responsive-padding-top"
                    >
                      <Text
                        className="text-black leading-[32px] ml-[20px] text-xl"
                        style={{
                          margin: 0,
                          lineHeight: "32px",
                          color: "#000000",
                      ...
                      >
                        <strong>%%First Name%%,<br></br>
                          ¡Vuélvete un experto en tpremia!
                        </strong>
                      </Text>
              ...
              <Row>
                <Column>
                  <Text className="text-[28px] text-black leading-[24px] text-center">
                    <strong>¡Aquí estamos para contarte cómo empezar con todo!</strong>
                  </Text>
                </Column>
              </Row>
            </Section>
            ...
            <Section>
              <Row>
                <Column align="center">
                  <Img
                    className=""
                    src={`https://res.cloudinary.com/dirjvoxdc/image/upload/v1757039618/card-container_dnmbzq.png`}
                    width="100%"
                    height="auto"
                  />
                </Column>
              ...
              <Row>
                <Column align="center">
                  <Text className="text-[28px] leading-[30px]">
                    Descubre los tipos de gemas y cómo aprovecharlas al máximo, <a
              ...
              <Row>
                <Column
                  style={{
                    ...
                    backgroundImage: `url(https://res.cloudinary.com/dirjvoxdc/image/upload/v1757040604/banner_bottom_nv9zr3.png)`,
