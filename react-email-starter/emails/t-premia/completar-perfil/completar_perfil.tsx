            ...
            <Section className="mx-0 my-[30px]">
              <Row>
                <Column>
                  <Img
                    className=""
                    src={`https://res.cloudinary.com/dirjvoxdc/image/upload/v1761931650/hero_completar_perfil_h83oox.png`}
                    width="100%"
                    height="auto"
                  />
                </Column>
              ...
              <Row>
                <Column>
                  <Text className="text-[28px] text-black leading-[24px] text-center mb-10">
                    <strong>Pásanos tu info y completa tu perfil</strong>
                  </Text>
                  <Text className="text-[24px] leading-[32px] text-center">
                    Así de fácil te echas unas gemitas en cuanto termines.
                  </Text>
                  <Text className="text-[24px] leading-[32px] text-center">
                    <strong>No lo pienses tanto… ¡las recompensas no esperan!</strong>
                  </Text>
                </Column>
              </Row>
            </Section>
                  ...
                  <Link href="t.premia.club/zGAf3Pc" style={{ textDecoration: "none" }}>
                    <div
                      style={{
                        ...
                        backgroundImage: `url(https://res.cloudinary.com/dirjvoxdc/image/upload/v1760464490/banne_activacion_ltkkwc.png)`,
