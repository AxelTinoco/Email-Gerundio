        ...
        <Body className="mx-auto my-auto bg-white px-2 font-sans">
          <Container className="mx-auto my-[40px] max-w-[650px] border-[#eaeaea] border-solid p-[20px]">
            ...
            <Section className="mx-0 my-[30px]">
              <Row>
                <Column>
                  <Img
                    className=""
                    src={`https://res.cloudinary.com/dirjvoxdc/image/upload/v1762244671/01_Captacion_hero_vl4h1z.png`}
                    width="100%"
                    height="auto"
                  />
                </Column>
              ...
              <Row>
                <Column>
                  ...
                  <Text className="text-[24px] leading-[32px] text-center">
                    Notamos que todavía no tienes cuenta en Banco Azteca y, déjanos contarte algo, te estás perdiendo la oportunidad de acumular muchísimas gemas.
                  </Text>
                  <Text className="text-[16px] leading-[32px] text-center">
                    Pero en tpremia siempre hay segundas oportunidades.
                  </Text>
                  <Text className="text-[16px] leading-[32px] text-center">
                    Solo recuerda: para completar tu misión de Cuenta Azteca de Banco Azteca, necesitas dejar tu deposito de $1,500 MXN por al menos 7 días.
                    Hazlo y verás cómo tu misión se completa solita.
                  </Text>
                  <Text className="text-[28px] text-black leading-[24px] text-center mb-10">
                    <strong>¿Le damos otra vuelta?</strong>
                  </Text>
            ...
            <Section className="mx-0 my-[30px] max-w-[650px] mx-auto">
              <Row>
                <Column>
                  <Link href="t.premia.club/4WgPWJz" style={{ textDecoration: "none" }}>
                    <div
                      style={{
                        backgroundImage: `url(https://res.cloudinary.com/dirjvoxdc/image/upload/v1762281056/01_footer_captacion_wsgalt.png)`,
