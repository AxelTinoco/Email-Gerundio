        ...
        <Body className="mx-auto my-auto bg-white px-2 font-sans">
          <Container className="mx-auto my-[40px] max-w-[650px] border-[#eaeaea] border-solid p-[20px]">
            ...
            <Section className="mx-0 my-[30px]">
              <Row>
                <Column>
                  <Img
                    className=""
                    src={`https://res.cloudinary.com/dirjvoxdc/image/upload/v1762245018/02_Hero_captacion_pp5fsg.png`}
                    width="100%"
                    height="auto"
                  />
                </Column>
              ...
              <Row>
                <Column>
                  ...
                  <Text className="text-[16px] leading-[32px] text-center">
                    Olvidaste activar tu misión de cuenta Azteca.
                  </Text>
                  <Text className="text-[16px] leading-[32px] text-center">
                    Activa la misión, haz tu depósito de $1,500 MXN en tu cuenta Azteca de Banco Azteca, mantenlo guardadito por 7 días y acumula gemas.
                  </Text>
                  <Text className="text-[28px] text-black leading-[24px] text-center mb-10">
            ...
            <Section className="mx-0 my-[30px]">
              <Row>
                <Column>
                  <Img
                    className=""
                    src={`https://res.cloudinary.com/dirjvoxdc/image/upload/v1762245019/02_numeralia_sfqsyk.png`}
                    width="100%"
                    height="auto"
                  />
                </Column>
            ...
            <Section className="mx-0 my-[30px] max-w-[650px] mx-auto">
              <Row>
                <Column>
                  <Link href="t.premia.club/Ik7hZbW" style={{ textDecoration: "none" }}>
                    <div
                      style={{
                        backgroundImage: `url(https://res.cloudinary.com/dirjvoxdc/image/upload/v1762281065/02_footer_captacion_ytkkzd.png)`,
