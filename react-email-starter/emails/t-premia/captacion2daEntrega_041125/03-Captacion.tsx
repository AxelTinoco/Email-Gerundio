        ...
        <Body className="mx-auto my-auto bg-white px-2 font-sans">
          <Container className="mx-auto my-[40px] max-w-[650px] border-[#eaeaea] border-solid p-[20px]">
            ...
            <Section className="mx-0 my-[30px]">
              <Row>
                <Column>
                  <Img
                    className=""
                    src={`https://res.cloudinary.com/dirjvoxdc/image/upload/v1762245186/03_Captacion_gj33jm.png`}
                    width="100%"
                    height="auto"
                  />
                </Column>
              ...
              <Row>
                <Column>
                  ...
                  <Text className="text-[24px] leading-[32px] text-center">
                    Notamos que todavía no tienes cuenta en <strong>Banco Azteca</strong> y, déjanos contarte algo, te estás perdiendo la oportunidad de <strong>acumular muchísimas gemas.</strong>
                  </Text>
                  <Text className="text-[24px] leading-[32px] text-center">
                    Corre a tu sucursal más cercana y abre tu cuenta. Ya que la tengas, <strong>activa la misión “Cuenta Azteca”</strong>, haz un deposito de <strong>$1,500 MXN</strong> y mantenlos guardaditos por <strong>7 días.</strong>
                  </Text>
                </Column>
              </Row>
            </Section>
            ...
            <Section className="mx-0 my-[30px] max-w-[650px] mx-auto">
              <Row>
                <Column>
                  <Link href="t.premia.club/1Z9rHU9" style={{ textDecoration: "none" }}>
                    <div
                      style={{
                        backgroundImage: `url(https://res.cloudinary.com/dirjvoxdc/image/upload/v1762281085/03_footer-_captacion_nf3vkq.png)`,
