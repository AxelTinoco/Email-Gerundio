        ...
        <Body className="mx-auto my-auto bg-white px-2 font-sans">
          <Container className="mx-auto my-[40px] max-w-[650px] border-[#eaeaea] border-solid p-[20px]">
            ...
            <Section className="mx-0 my-[30px] max-w-[650px] mx-auto">
              <Row>
                <Column>
                    <div
                      style={{
                        backgroundImage: `url(https://res.cloudinary.com/dirjvoxdc/image/upload/v1761940709/hero_nps_q5itth.png)`,
                    ...
                    >
                      <div className="flex w-full justify-content-center mx-0">
                        <div
                          style={{
                            verticalAlign: "",
                            padding: "20px",
                          }}
                          className="bg-white rounded-lg w-[350px] mx-0"
                        >
                          [Nombre], dime la neta… ¿qué tan feliz te hacen tus gemas?
                        </div>
                      </div>
                    </div>
                </Column>
              ...
              <Row>
                <Column>
                  <Text className="text-[24px] text-black leading-[24px] text-center mb-10">
                    <strong>¡Oye! Tenemos que hablar de tu cuenta </strong>
                  </Text>
                  <Text className="text-[24px] leading-[32px] text-justify">
                    <strong>Por ahora está suspendida</strong>, lo que significa que no puedes acumular ni usar gemas. Pero no te preocupes, todavía se puede arreglar.
                  </Text>
                  <Text className="text-[24px] leading-[32px] text-justify">
                    Sigue estos pasos para reactivarla y vuelve a las misiones, recompensas y toda la aventura que te espera.
                  </Text>
                  <Text className="text-[24px] leading-[32px] text-justify">
                    Si tienes dudas, <strong>aquí está Gemmita para ayudarte.</strong>
                  </Text>
                </Column>
              </Row>
            </Section>
            ...
            <Section className="mx-0 my-[30px] text-center">
              <Row>
                <Column>
                  <Img
                    className="mx-auto"
                    src={`https://res.cloudinary.com/dirjvoxdc/image/upload/v1761940049/gema_cuenta_suspednida_mp12kc.png`}
                    width="70%"
                    height="auto"
                  />
                </Column>
            ...
            <Section className="mx-0 my-[30px] max-w-[650px] mx-auto">
              <Row>
                <Column>
                  <Link href="t.premia.club/zGAf3Pc" style={{ textDecoration: "none" }}>
                    <div
                      style={{
                        // backgroundImage: `url(${baseUrl}/static/t-premia/Banner_gema_gift.png)`,
                        backgroundImage: `url(https://res.cloudinary.com/dirjvoxdc/image/upload/v1761940181/footer_cuenta_suspendida_ixkpoe.png)`,
                        backgroundSize: "contain",
                        backgroundPosition: "center",
                        backgroundRepeat: "no-repeat",
                        height: "350px",
