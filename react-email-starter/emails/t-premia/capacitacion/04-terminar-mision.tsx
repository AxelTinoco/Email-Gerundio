            ...
            <Section className="mx-0 my-[30px]">
              <Row>
                <Column>
                  <Img
                    className=""
                    src={`https://res.cloudinary.com/dirjvoxdc/image/upload/v1760487327/termino-mision_avex9u.png`}
                    width="100%"
                    height="auto"
                  />
                </Column>
              ...
              <Row>
                <Column>
                  ...
                  <Text className="text-[24px] leading-[32px] text-center">
                    ¡Eso, misión cumplida! <br></br>
                    Te acabas de llevar [X] gema bien brillosa. No pares aquí, sigue acumulando más gemas y úsalas en recompensas que te van a sacar una sonrisa gigante.
                  </Text>
                  <Text className="text-[24px] leading-[32px] text-center">
                    Cada depósito es 1 gema.
