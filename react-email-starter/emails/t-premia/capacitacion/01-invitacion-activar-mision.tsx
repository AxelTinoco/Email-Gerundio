            ...
            <Section className="mx-0 my-[30px]">
              <Row>
                <Column>
                  <Img
                    className=""
                    src={`https://res.cloudinary.com/dirjvoxdc/image/upload/v1760484966/hero_activar_kxvhpl.png`}
                    width="100%"
                    height="auto"
                  />
                </Column>
              ...
              <Row>
                <Column>
                  ...
                  <Text className="text-[24px] leading-[32px] text-center">
                    Haz un depósito de <strong>$1500 MXN </strong> en tu cuenta Azteca de Banco Azteca, mantenlo guardadito por 7 días y ¡zas! se te acumula <strong>1 gema </strong> directo en tu cuenta.
                  </Text>
                </Column>
              </Row>
            </Section>
