            ...
            <Section className="mx-0 my-[30px]">
              <Row>
                <Column>
                  <Img
                    className=""
                    src={`https://res.cloudinary.com/dirjvoxdc/image/upload/v1760487002/terminar-mision-hero_o1w4ox.png`}
                    width="100%"
                    height="auto"
                  />
                </Column>
              ...
              <Row>
                <Column>
                  ...
                  <Text className="text-[24px] leading-[32px] text-center">
                    Tus gemas te esperan, termina tu misión depositando <strong>$1500 MXN</strong> en tu cuenta Banco Azteca, mantenlo guardadito por 7 días y ¡listo!.
                  </Text>
                  <Text className="text-[24px] leading-[32px] text-center">
                  ...
                  <Link href="t.premia.club/V4pXJTG" style={{ textDecoration: "none" }}>
                    <div
                      style={{
                        ...
                        backgroundImage: `url(https://res.cloudinary.com/dirjvoxdc/image/upload/v1760487180/invitar_termino_mision_jaryyl.png)`,
