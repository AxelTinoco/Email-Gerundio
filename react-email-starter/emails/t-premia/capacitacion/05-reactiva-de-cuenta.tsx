        ...
        <Body className="mx-auto my-auto bg-white px-2 font-sans">
          <Container className="mx-auto my-[40px] max-w-[650px] border-[#eaeaea] border-solid p-[20px]">
            ...
            <Section className="mx-0 my-[30px]">
              <Row>
                <Column>
                  <Img
                    className=""
                    src={`https://res.cloudinary.com/dirjvoxdc/image/upload/v1761075878/Frame_1171275224_bt72so.png`}
                    width="100%"
                    height="auto"
                  />
                </Column>
              ...
              <Row>
                <Column>
                  ...
                  <Text className="text-[16px] leading-[32px] text-center">
                    Ya completaste esta misión antes, ¡y lo hiciste increíble! Ahora puedes reactivarla y ganar <strong>1 gema más.</strong>
                  </Text>
                  <Text className="text-[16px] leading-[32px] text-center">
                    ¡Haz un depósito de  <strong>$1,500.00 MXN</strong> en tu cuenta Azteca de Banco Azteca, mantenlo guardadito por 7 días  y acumula gemas!
                  </Text>
                </Column>
              </Row>
            </Section>
            ...
            <Section className="mx-0 my-[30px] max-w-[650px] mx-auto">
              <Row>
                <Column>
                  <Link href="t.premia.club/9BJ3PvH" style={{ textDecoration: "none" }}>
                    <div
                      style={{
                        // backgroundImage: `url(${baseUrl}/static/t-premia/Banner_gema_gift.png)`,
                        backgroundImage: `url(https://res.cloudinary.com/dirjvoxdc/image/upload/v1760487672/footer_terminar_mision_pjpzvv.png)`,
