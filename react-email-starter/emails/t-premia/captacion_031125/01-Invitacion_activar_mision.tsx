        ...
        <Body className="mx-auto my-auto bg-white px-2 font-sans">
          <Container className="mx-auto my-[40px] max-w-[650px] border-[#eaeaea] border-solid p-[20px]">
            ...
            <Section className="mx-0 my-[30px]">
              <Row>
                <Column>
                  <Img
                    className=""
                    src={`https://res.cloudinary.com/dirjvoxdc/image/upload/v1762196351/01_Hero_Invitacion_activar_onfxlf.png`}
                    width="100%"
                    height="auto"
                  />
                </Column>
              ...
              <Row>
                <Column>
                  ...
                  <Text className="text-[16px] leading-[32px] text-center">
                    Haz un depósito de <strong>$1,500.00 MXN</strong> en tu Cuenta Azteca en Banco Azteca, mantenlo guardadito por 7 días y ¡zas! se te acumula <strong>1 gema </strong>
                    directo en tu cofre.
                  </Text>
                </Column>
              </Row>
            ...
            <Section className="mx-0 my-[30px] max-w-[650px] mx-auto">
              <Row>
                <Column>
                  <Link href="t.premia.club/2SpUOaw" style={{ textDecoration: "none" }}>
                    <div
                      style={{
                        backgroundImage: `url(https://res.cloudinary.com/dirjvoxdc/image/upload/v1762196352/footer_invitacion_activacion_mision_r0ygau.png)`,
