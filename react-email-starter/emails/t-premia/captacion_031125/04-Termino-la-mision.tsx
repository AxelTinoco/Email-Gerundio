        ...
        <Body className="mx-auto my-auto bg-white px-2 font-sans">
          <Container className="mx-auto my-[40px] max-w-[650px] border-[#eaeaea] border-solid p-[20px]">
            ...
            <Section className="mx-0 my-[30px]">
              <Row>
                <Column>
                  <Img
                    className=""
                    src={`https://res.cloudinary.com/dirjvoxdc/image/upload/v1762211200/04_hero_termino_mision_vvae84.png`}
                    width="100%"
                    height="auto"
                  />
                </Column>
            ...
            <Section>
              <Row>
                <Column>
                  ...
                  <Text className="text-[16px] leading-[32px] text-center">
                    Te acabas de llevar %% X gemas bien brillosas%%. No pares aquí, sigue acumulando más gemas y úsalas en recompensas que te van a sacar una sonrisa gigante.
                  </Text>
                  <Text className="text-[16px] leading-[16px] text-center">
                    Cada depósito de $1500 es 1 gema
                  </Text>
                  <Text className="text-[16px] leading-[16px] text-center">
                    ¡Deposita más y acumula más!
                  </Text>
                </Column>
              </Row>
            </Section>
            ...
            <Section className="mx-0 my-[30px] max-w-[650px] mx-auto">
              <Row>
                <Column>
                  <Link href="t.premia.club/V4pXJTG" style={{ textDecoration: "none" }}>
                    <div
                      style={{
                        backgroundImage: `url(https://res.cloudinary.com/dirjvoxdc/image/upload/v1762211202/04_termino_la_mision_jikgfn.png)`,
